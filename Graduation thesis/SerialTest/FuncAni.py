...
ser = serial.Serial('/dev/tty.usbmodem1301', 9600)  # シリアル通信の設定
...
# ani_CapSen = FuncAnimation(fig_CapSen, update_CapSen, init_func=init, blit=True , interval=100,cache_frame_data=False)
